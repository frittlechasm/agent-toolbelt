...
Before rendering, read [references/diagrams.md](references/diagrams.md) completely.
It is the sole source of SVG design, layout, responsive, accessibility, mechanics, and verification requirements.

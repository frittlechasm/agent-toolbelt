...
Use these to improve existing content when requested or naturally useful.
They must not introduce facts or impose a structure that changes the content's meaning.
...
- **Diff:** Use patch-style presentation when exact changed lines matter; use before/after panels when behavior or concepts matter more. Preserve source order and keep line numbers and signs compact.
- **Callout:** Emphasize a supported warning, constraint, decision, or non-obvious gotcha that readers could otherwise miss. Keep ordinary detail in the main flow.
- **Wide media:** Scale media to the content column first. If shrinking destroys legibility, constrain horizontal scrolling to that item rather than the page.
